...
<html>
<head>
    <title>Change To Member Role</title>
  <style>
  body{
...
<br><br><br>
<h1 style="color:white;text-align: center;">CHANGE THE ROLE STATUS</h1><br/>
<h1>
  <%
    int status= manageuser.changeUserToMember(obj);
    if(status>0)
      out.println("Changed to member role successfully");
    else
      out.println("Not able to change the role");
  %>
</h1>
</body>
</html>
