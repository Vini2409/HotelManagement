...
<nav>
    ...
    <a href="../user/guestSignup.jsp">ADD</a>
</nav>
<br><br><br>
...
<%
    ...
    if(list.size()==0){
        ...
        for (hotelBean s : list) {
            ...
            template.append("<form action=../user/edituserprofile.jsp method='post' ><Button style='background-color:#4AE0EA;' name='update' value=").append(s.getGuestid()).append(">UPDATE USER</Button></div>").append("</form></center></div>");
        }
    }
    ...
    if(listMember.size()==0){
        ...
        for (hotelBean s : listMember) {
            ...
            templateMember.append("<form action=../member/editMemberProfile.jsp method='post' ><Button style='background-color:#4AE0EA;' name='updateMember' value=").append(s.getGuestid()).append(">UPDATE USER</Button></div>").append("</form></center></div>");
        }
    }
%>
<table>
