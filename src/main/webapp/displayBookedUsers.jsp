...
<%
    ...
    if(list.size()==0){
        ...
        template.append("<tr>").append("<td> Room No.</td>").append("<td>Name</td>").append("<td>Email ID</td>").append("<td>Contact Number</td>").append("<td>No_Of_People</td>").append("<td>Check In</td>").append("<td>Check Out</td></tr>\n");
