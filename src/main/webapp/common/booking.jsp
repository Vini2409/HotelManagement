...
%>
<table>
    <form name="f1" method="post" action="../user/userdb.jsp" id="f1" >
        <%
        ...
        <tr><td>Confirm Check In: </td><td><input style="font-size:25px;" type="date" name="checkin" placeholder="dd-mm-yyy"/></td></tr><br><br>
        <tr><td>Confirm Check Out: </td><td><input style="font-size:25px;" type="date" name="checkout" placeholder="dd-mm-yyy"/></td></tr><br><br>
        <tr><td><input style="font-size:25px;margin-left:150px;margin-top:50px;padding:5px;" type="submit" value="CONFIRM BOOK"/></td></tr>
    </form>
</table>
</body>
</html>
