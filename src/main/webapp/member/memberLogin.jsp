...
<br><br><br><br>
<form method="post" action="memberLoginValidation.jsp">
    ...
    <table>
        ...
        <tr>
            <td>NEW USER ? </td>
            <td> <a style="text-decoration: none;"href="memberSignUp.jsp">SignUp</a></td>
        </tr>
        <tr>
            <td><a href="changePasswordMember.jsp">Forgot password</a></td>
            <td>&nbsp;</td>
        </tr>
        </tbody>
    </table>
